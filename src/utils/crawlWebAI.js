...
function handleUnwantedOrOffTopicQuestion(query) {
  ...
  const isAcademicQuery = /college|university|institute|school|course|degree|btech|b\.e|mbbs|bds|bca|mca|mba|placement|fee|cutoff|tnea|jee|neet|gate|clat|scholarship|hostel|campus|admission|engineering|medical|arts|commerce|science|department|faculty|career|salary|internship|syllabus|exam|rank|accreditation|naac|nirf|aictes|ugc|study|learn|dsa|coding|vlsi|ai|data science|psychology|law|student|cgpa|backlog|diploma|polytechnic|iti|sop|lor|ielts|toefl|gre|gmat|visa/i.test(q);
