  ...
  const html = `
    <div style="font-family:sans-serif;max-width:480px;margin:0 auto;padding:32px;background:#f0f4ff;border-radius:16px">
      <div style="text-align:center;margin-bottom:24px">
        ...
        <h2 style="color:#1e3a8a;margin-top:12px">SmartCampus AI</h2>
      </div>
      ...
      <p style="color:#9ca3af;font-size:11px;text-align:center;margin-top:16px">SmartCampusAI · India's Smartest College Finder</p>
    </div>
  `;
  await transporter.sendMail({
    from:    `"SmartCampus AI" <${process.env.GMAIL_USER}>`,
    to:      email,
    subject: `Your OTP: ${otp} — SmartCampus AI`,
    html,
  });
}
...
app.listen(PORT, '127.0.0.1', () => {
  console.log(`\n🔐 SmartCampusAI Auth Server running at http://localhost:${PORT}`);
